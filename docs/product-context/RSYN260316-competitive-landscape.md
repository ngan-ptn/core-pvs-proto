...
Mapping **practice scale vs operational intelligence** reveals a market
gap.
  ...
  Multi-location orchestration            (empty market space)

CorePVS targets the **multi-location orchestration** quadrant.
