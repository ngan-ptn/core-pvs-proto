...
- Preferred output:
  - Mermaid flow summary
  - Screen map with related user actions, system actions, and states grouped per screen
  - Mermaid journey/state diagram when the flow is multi-step, stateful, or branched
