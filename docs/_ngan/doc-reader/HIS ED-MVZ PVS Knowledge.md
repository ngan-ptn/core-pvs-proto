...
*Extracted from [HIS ED- MVZ PVS Core Knowledge.md](HIS%20ED-%20MVZ%20PVS%20Core%20Knowledge.md) and [RSYN260316-competitive-landscape.md](RSYN260316-competitive-landscape.md). These are validated observations, not open questions — they inform the questions above.*
