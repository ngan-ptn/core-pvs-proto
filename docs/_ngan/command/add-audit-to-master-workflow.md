...
| Select | Workflow | Audit |
|---|---|---|
| `WF-1` | Patient Check-In & Registration | `--` or `[View](path-to-audit.md)` |
| `WF-2` | Insurance & Enrollment (HZV/FAV) | `--` or `[View](path-to-audit.md)` |
| `WF-3` | Forms & Certificates | `--` or `[View](path-to-audit.md)` |
| `WF-4` | Clinical Documentation | `--` or `[View](path-to-audit.md)` |
| `WF-5` | Service & Billing Documentation | `--` or `[View](path-to-audit.md)` |
| `WF-6` | Prescriptions (Core) | `--` or `[View](path-to-audit.md)` |
| `WF-7` | Prescriptions (Specialty) | `--` or `[View](path-to-audit.md)` |
| `WF-8` | Forms & Certificates | `--` or `[View](path-to-audit.md)` |
| `WF-9` | Chronic Care Programs | `--` or `[View](path-to-audit.md)` |
| `WF-10` | Billing & Submission | `--` or `[View](path-to-audit.md)` |
| `WF-11` | ePA & Document Exchange | `--` or `[View](path-to-audit.md)` |
| `WF-12` | Practice Administration | `--` or `[View](path-to-audit.md)` |
| `WF-13` | System Infrastructure | `--` or `[View](path-to-audit.md)` |
| `WF-14` | Data Import & Sync | `--` or `[View](path-to-audit.md)` |
...
### 2b. Update the `Workflow Index` audit column
...
- only update the `Audit` column values
...
3. A `Workflow Index` whose `Audit` column shows `--` for unaudited workflows and `View` links for audited workflows
4. Side-by-side alternate workflows only for the user-selected workflows
5. A `Key differences` table with `Design implication` for each synced workflow
6. Any required path-reference cleanup after renaming or moving the master file
