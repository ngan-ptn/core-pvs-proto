...
describe('main-app i18n', () => {
  ...
  it('translates app-specific keys', () => {
    expect(instance.t('app:title')).toBe('Main App')
    expect(instance.t('app:description')).toContain('Main application')
  })
  ...
  it('switches to German', async () => {
    ...
    expect(instance.t('app:title')).toBe('Hauptanwendung')
