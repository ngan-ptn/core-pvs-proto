...
export function LanguageToggle() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex rounded-full bg-background/80 backdrop-blur border shadow-sm text-sm overflow-hidden" role="group" aria-label="Language selection">
      <button
        className={cn(
