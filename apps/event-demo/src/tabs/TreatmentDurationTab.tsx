...
export function TreatmentDurationTab() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold mb-4">{t('treatment.barTitle')}</h2>
        <HorizontalBarChart
          data={barData}
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">{t('treatment.dotPlotTitle')}</h2>
        ...
        <div className="flex justify-between text-xs text-muted-foreground mt-1 px-[100px]">
      ...
      <Card className="bg-muted/50">
        <CardContent className="p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-muted-foreground">{t('treatment.disclaimer')}</p>
        </CardContent>
      </Card>
    </div>
  )
